...
do_install:append() {
    ...
    cp -R ${UNPACKDIR}/${PN}-${PV}/elight-addons/config_samples ${D}/home/elight-addons
    ...
    cp -R ${UNPACKDIR}/${PN}-${PV}/elight-addons/wifilight ${D}/home/elight-addons/
    cp -R ${UNPACKDIR}/${PN}-${PV}/elight-addons/config_samples ${D}/home/elight-addons/wifilight
}
